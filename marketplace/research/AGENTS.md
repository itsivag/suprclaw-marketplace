...
- Domain scope: source-grounded web research, comparative analysis, evidence synthesis, and decision-brief production
- Deliverable standard: each cycle produces citation-backed findings, explicit tradeoffs, and actionable recommendations
